...
import cardsText from '../public/cardsText.json';

export default function Home() {


  return (
    <div className='bg-black w-screen max-h-screen h-screen'>
      <Head>
      ...
      <div className='flex flex-row place-content-between h-2/3'>
        <Card title={cardsText.card1.title}>{cardsText.card1.text}</Card>
        <Button fnctOnClick={()=>{}}/>
      </div>
